...
<ul>
 ...
 <div id="dcMain"> <!-- 当前位置 -->
<div id="urHere"><a href="/xionghaizi/admin.php/Index/index.html">首页</a><b>></b><strong>评论管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/xionghaizi/admin.php/Comment/lists.html" class="actionBtn">返回列表</a>查看评论</h3>
   <form action="/xionghaizi/admin.php/Comment/add" method="post">
      <input type="hidden" name="commentid" value="<?php echo ($data["commentid"]); ?>" >
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
       <td width="80" align="center">分享id</td>
       <td>
        <input type="text" name="shareid" value="<?php echo ($data["shareid"]); ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td width="80" align="center">评论人</td>
       <td>
        <input type="text" name="commentuserid" value="<?php echo ($data["commentuserid"]); ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="center">评论内容</td>
       <td>
        <textarea name="commentcontent" cols="60" rows="4" class="textArea"><?php echo ($data["commentcontent"]); ?></textarea>
       </td>
      </tr>
      <tr>
       <td align="center">评论时间</td>
       <td>
        <input type="text" name="commenttime" value="<?php echo ($data["commenttime"]); ?>" size="5" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td></td>
