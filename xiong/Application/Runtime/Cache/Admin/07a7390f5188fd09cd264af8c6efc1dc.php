...
<ul>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere"><a href="/xionghaizi/admin.php/Index/index.html">首页</a><b>></b><strong>用户管理</strong> </div>   
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="/xionghaizi/admin.php/User/adduser" class="actionBtn add">添加用户</a>用户列表</h3>
  
        <div id="list">
    <form action="/xionghaizi/admin.php/User/delete">
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        <td align="center"><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" class="checkbox"/></td>
        <td align="center"><?php echo ($vo["id"]); ?></td>
        <td align="center"><?php echo ($vo["username"]); ?></td>
        <td align="center"><?php echo ($vo["sign"]); ?></td>
        <td align="center"><?php echo ($vo["sex"]); ?></td>
        <td align="center"><?php echo ($vo["birthday"]); ?></td>
        <td align="center"><?php echo ($vo["school"]); ?></td>
        <td align="center"><?php echo ($vo["integral"]); ?></td>
        <td align="center"><?php echo ($vo["jointime"]); ?></td>
        <td align="center">
        <a href="/xionghaizi/admin.php/User/edituser?id='<?php echo ($vo['id']); ?>'">查看</a> | <a href="/xionghaizi/admin.php/User/delete?id='<?php echo ($vo['id']); ?>'">删除</a>
        </td>
