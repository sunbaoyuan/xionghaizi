...
<div id="urHere"><a href="/xionghaizi/admin.php/Index/index.html">首页</a><b>></b><strong>挑战管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/xionghaizi/admin.php/Challenge/lists" class="actionBtn">返回列表</a>题目列表</h3>

    <form action="/xionghaizi/admin.php/Challenge/doAdd" method="post">
       ...
       <td>
        <select name="ccid">
         <!-- <option value="0">未分类</option> -->
            <?php if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><option value="<?php echo ($t["ccid"]); ?>">- <?php echo ($t["typeccname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
      </tr>
      <tr>
          <td align="center">题目</td>
          <td>
            <input type="text" name="challengename" size="40" class="inpMain" />
          </td>
        </tr>
      <tr>
      <tr>
       ...
       <td>
        <textarea name="challengecontent" cols="60" rows="4" class="textArea"></textarea>
       </td>
      </tr>
      <tr>
