...
<ul>
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere"><a href="/xionghaizi/admin.php/Index/index.html">首页</a><b>></b><strong>故事管理</strong> </div>   
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="/xionghaizi/admin.php/Story/addstory" class="actionBtn add">添加故事</a>故事列表</h3>
  
        <div id="list">
    <form  action="/xionghaizi/admin.php/Story/delete">
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <th align="center">故事名</th>
        <th width="" align="center">内容</th>
        <th width="" align="center">添加日期</th>
        <th width="" align="center">操作</th>
      </tr>

      <?php if(is_array($story)): $i = 0; $__LIST__ = $story;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        <td align="center"><input type="checkbox" name="storyid[]" value="<?php echo ($vo["storyid"]); ?>" class="checkbox"/></td>
        <td align="center"><?php echo ($vo["storyid"]); ?></td>
        <td align="center"><?php echo ($vo["storytitle"]); ?></td>
        <td align="center"><?php echo (mb_substr($vo["storycontent"],0,8,'utf-8')); ?></td>
        <td align="center"><?php echo ($vo["addtime"]); ?></td>
        <td align="center">
        <a href="/xionghaizi/admin.php/Story/editstory/storyid/<?php echo ($vo["storyid"]); ?>">编辑</a> | <a href="/xionghaizi/admin.php/Story/delete/storyid/<?php echo ($vo["storyid"]); ?>">删除</a>
        </td>
