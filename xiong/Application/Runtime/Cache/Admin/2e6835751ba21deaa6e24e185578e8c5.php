...
<div id="dcWrap"> <div id="dcHead">
 <div id="head">
  ...
  <div class="nav">
   ...
   <ul class="navRight">
    <li class="noRight"><a href="/xionghaizi/index.php/Admin/Admin/editmanager">您好，admin</a>
     
    </li>
    <li class="noRight"><a href="/xionghaizi/index.php/Admin/Admin/login">退出</a></li>
   </ul>
  </div>
 </div>
</div>
...
<ul>
 ...
 <ul>
  <li><a href="/xionghaizi/index.php/Admin/Comment/lists.html"><em style="text-align:center;">评论管理</em></a></li>
 </ul>
 <ul>
 ...
 <div id="dcMain"> <!-- 当前位置 -->
<div id="urHere"><a href="/xionghaizi/index.php/Admin/Index/index.html">首页</a><b>></b><strong>管理员管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/xionghaizi/index.php/Admin/Admin/manager.html" class="actionBtn">返回列表</a>网站管理员</h3>
