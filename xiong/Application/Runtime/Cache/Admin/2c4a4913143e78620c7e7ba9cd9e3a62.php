...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        <td align="center"><input type="checkbox" name="id[]" value="<?php echo ($vo["commentid"]); ?>" /></td>
        <td align="center"><?php echo ($vo["commentid"]); ?></td>
        <td align="center"><?php echo ($vo["title"]); ?></td>
        <td align="center"><?php echo ($vo["commentuserid"]); ?></td>
        <td align="center"><?php echo ($vo["commentcontent"]); ?></td>
        <td align="center"><?php echo ($vo["commenttime"]); ?></td>
        <td align="center">
        <a href="/xionghaizi/admin.php/Comment/edit?id='<?php echo ($vo['commentid']); ?>'">查看</a> | <a href="/xionghaizi/admin.php/Comment/delete?id='<?php echo ($vo['commentid']); ?>'">删除</a>
        </td>
      </tr><?php endforeach; endif; else: echo "" ;endif; ?>
      </table>
      <br/>
        <div class="input-group pull-left form">
            <button type="submit" class="btn" style="background-color:#20B2AA;">批量删除</button>
        </div>
    </form>
    </div>
    <div class="clear"></div>
