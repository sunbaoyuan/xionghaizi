	...
	<body>
		<div data-role="page" id="one" class="bg" >
	        <div data-role="header" id="col" data-position="fixed">
	            ...
	            <a href="/xionghaizi/index.php/Home/Challenge/yingyu_guanka" data-role="button" rel="external">返回</a>
	        </div>
	        <div data-role="content" id="cont">
	            
	        	<p style="font-size:25px">1.This is my __________(爸爸),He is a __________(老师).</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="one" type="radio" value="A" />A.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					<label><input name="one" type="radio" value="B" />B.brother&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="one" type="radio" value="C" />C.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="one" type="radio" value="D" />D.mother&nbsp;&nbsp;&nbsp;&nbsp;doctor</label>  
					</form> 
	        	</div>
	    ...
	    <div data-role="page" id="two" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">2.This is my __________(爸爸),He is a __________(老师).</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="two" type="radio" value="A" />A.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					<label><input name="two" type="radio" value="B" />B.brother&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="two" type="radio" value="C" />C.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="two" type="radio" value="D" />D.mother&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="three" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">3.This is my __________(爸爸),He is a __________(老师).</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="three" type="radio" value="A" />A.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					<label><input name="three" type="radio" value="B" />B.brother&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="three" type="radio" value="C" />C.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="three" type="radio" value="D" />D.mother&nbsp;&nbsp;&nbsp;&nbsp;doctor</label>  
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="four" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">4.This is my __________(爸爸),He is a __________(老师).</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="four" type="radio" value="A" />A.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					<label><input name="four" type="radio" value="B" />B.brother&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="four" type="radio" value="C" />C.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="four" type="radio" value="D" />D.mother&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="five" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">5.This is my __________(爸爸),He is a __________(老师).</p>


	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="five" type="radio" value="A" />A.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					<label><input name="five" type="radio" value="B" />B.brother&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="five" type="radio" value="C" />C.father&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;teacher</label> 
					<label><input name="five" type="radio" value="D" />D.mother&nbsp;&nbsp;&nbsp;&nbsp;doctor</label> 
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    	...
	    	function pageName()  
		     {  
		      ...
		      function getgrade(){
	    		...
	    		// alert(a);
	    		window.location.href="/xionghaizi/index.php/Home/Challenge/yingyu_guanka.html?"+a;
	    	}
	    	count=0;
			function GetData1()
			{
