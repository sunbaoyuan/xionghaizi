	...
	<body>
		<div data-role="page" id="one" class="bg" >
	        <div data-role="header" id="col" data-position="fixed">
	            ...
	            <a href="/xionghaizi/index.php/Home/Challenge/chengyu_guanka" data-role="button" rel="external">返回</a>
	        </div>
	        <div data-role="content" id="cont">
	            
	        	<p style="font-size:25px">1._____苗助长,_____耳盗铃;</p>
	        	<p style="margin-left:40%">&nbsp;</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="one" type="radio" value="A" />A.压&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼</label> 
					<label><input name="one" type="radio" value="B" />B.押&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="one" type="radio" value="C" />C.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="one" type="radio" value="D" />D.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岩</label>  
					</form> 
	        	</div>
	    ...
	    <div data-role="page" id="two" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">2._____苗助长,_____耳盗铃;</p>
	        	<p style="margin-left:40%">&nbsp;</p>


	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="two" type="radio" value="A" />A.压&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼</label> 
					<label><input name="two" type="radio" value="B" />B.押&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="two" type="radio" value="C" />C.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="two" type="radio" value="D" />D.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岩</label>
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="three" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">3._____苗助长,_____耳盗铃;</p>
	        	<p style="margin-left:40%">&nbsp;</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="three" type="radio" value="A" />A.压&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼</label> 
					<label><input name="three" type="radio" value="B" />B.押&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="three" type="radio" value="C" />C.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="three" type="radio" value="D" />D.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岩</label>
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="four" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">4._____苗助长,_____耳盗铃;</p>
	        	<p style="margin-left:40%">&nbsp;</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="four" type="radio" value="A" />A.压&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼</label> 
					<label><input name="four" type="radio" value="B" />B.押&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="four" type="radio" value="C" />C.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="four" type="radio" value="D" />D.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岩</label> 
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="five" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">5._____苗助长,_____耳盗铃;</p>
	        	<p style="margin-left:40%">&nbsp;</p>


	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="five" type="radio" value="A" />A.压&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;眼</label> 
					<label><input name="five" type="radio" value="B" />B.押&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="five" type="radio" value="C" />C.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;掩</label> 
					<label><input name="five" type="radio" value="D" />D.揠&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岩</label>
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <script type="text/javascript">
	    	function pageName()  
		     ...
		     function getgrade(){
	    		...
	    		// alert(a);
	    		window.location.href="/xionghaizi/index.php/Home/Challenge/chengyu_guanka.html?"+a;
	    	}  
	    	count=0;
			function GetData1()
			{
