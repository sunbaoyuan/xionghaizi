	...
	<body>
		<div data-role="page" id="one" class="bg" >
	        <div data-role="header" id="col" data-position="fixed">
	            ...
	            <a href="/xionghaizi/index.php/Home/Challenge/shuxue_guanka" data-role="button" rel="external">返回</a>
	        </div>
	        <div data-role="content" id="cont">
	            
	        	<p style="font-size:25px">1.我有5个苹果,吃了1个,给了小明2个,现在还剩下几个苹果？</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="one" type="radio" value="A" />A.&nbsp;&nbsp;5个</label> 
					<label><input name="one" type="radio" value="B" />B.&nbsp;&nbsp;4个</label> 
					<label><input name="one" type="radio" value="C" />C.&nbsp;&nbsp;2个</label> 
					<label><input name="one" type="radio" value="D" />D.&nbsp;&nbsp;1个</label>  
					</form> 
	        	</div>
	    ...
	    <div data-role="page" id="two" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">2.我有5个苹果,吃了1个,给了小明2个,现在还剩下几个苹果？</p>


	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="two" type="radio" value="A" />A.&nbsp;&nbsp;5个</label> 
					<label><input name="two" type="radio" value="B" />B.&nbsp;&nbsp;4个</label> 
					<label><input name="two" type="radio" value="C" />C.&nbsp;&nbsp;2个</label> 
					<label><input name="two" type="radio" value="D" />D.&nbsp;&nbsp;1个</label>  
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="three" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">3.我有5个苹果,吃了1个,给了小明2个,现在还剩下几个苹果？</p>


	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="three" type="radio" value="A" />A.&nbsp;&nbsp;5个</label> 
					<label><input name="three" type="radio" value="B" />B.&nbsp;&nbsp;4个</label> 
					<label><input name="three" type="radio" value="C" />C.&nbsp;&nbsp;2个</label> 
					<label><input name="three" type="radio" value="D" />D.&nbsp;&nbsp;1个</label>  
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="four" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">4.我有5个苹果,吃了1个,给了小明2个,现在还剩下几个苹果？</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="four" type="radio" value="A" />A.&nbsp;&nbsp;5个</label> 
					<label><input name="four" type="radio" value="B" />B.&nbsp;&nbsp;4个</label> 
					<label><input name="four" type="radio" value="C" />C.&nbsp;&nbsp;2个</label> 
					<label><input name="four" type="radio" value="D" />D.&nbsp;&nbsp;1个</label>  
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <div data-role="page" id="five" class="bg">
	        ...
	        <div data-role="content" id="cont">
	        	...
	        	<p style="font-size:25px">5.我有5个苹果,吃了1个,给了小明2个,现在还剩下几个苹果？</p>

	        	<div style="margin-top:10%">
	        		<form action="" method="get"> 
					<label><input name="five" type="radio" value="A" />A.&nbsp;&nbsp;5个</label> 
					<label><input name="five" type="radio" value="B" />B.&nbsp;&nbsp;4个</label> 
					<label><input name="five" type="radio" value="C" />C.&nbsp;&nbsp;2个</label> 
					<label><input name="five" type="radio" value="D" />D.&nbsp;&nbsp;1个</label>  
					</form> 
	        	</div>
	        	<div style="margin-top:30%">
	    ...
	    <script type="text/javascript">
	    	function pageName()  
		     ...
		     function getgrade(){
	    		...
	    		// alert(a);
	    		window.location.href="/xionghaizi/index.php/Home/Challenge/shuxue_guanka.html?"+a;
	    	}
	    	count=0;
			function GetData1()
			{
